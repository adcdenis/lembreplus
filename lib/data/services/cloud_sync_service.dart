...
import 'package:lembreplus/data/services/cloud_sync_firebase.dart';
...
class NoopCloudSyncService implements CloudSyncService {
  ...
  Future<void> signInWithGoogle() async {
    ...
    throw 'Login Google indisponível. Configure Firebase/Google Sign-In (veja README).';
  }
...
CloudSyncService createCloudSyncService(AppDatabase db) {
  if (useFirebaseCloudSync) {
    return FirebaseCloudSyncService(db);
  }
