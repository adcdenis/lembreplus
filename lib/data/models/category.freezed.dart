...
abstract class $CategoryCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String name, String normalized});
}
...
class _$CategoryImpl implements _Category {
  const _$CategoryImpl({this.id, required this.name, required this.normalized});
  ...
  @override
  String toString() {
    return 'Category(id: $id, name: $name, normalized: $normalized)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, normalized);
